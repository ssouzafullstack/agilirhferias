...
namespace AgiliRHFerias.Presentation.Controllers
{
    ...
    public class EmployeesController : ControllerBase
    {
        ...
        {
            var result = await _service.EmployeeService.GetEmployeesAsync(companyId, employeeParameters, trackChanges: false);
        ...
        {
            var employee = await _service.EmployeeService.GetEmployeeAsync(companyId, id, trackChanges: false); return Ok(employee);
        }
